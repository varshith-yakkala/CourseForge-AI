...
from sqlalchemy import ForeignKey, Integer, String, Date, ARRAY, JSON
...
class StudyPlan(Base, UUIDMixin, TimestampMixin):
    ...
    preferred_study_days = mapped_column(JSON().with_variant(ARRAY(String), "postgresql"), nullable=True) # ["Mon", "Wed", "Fri"]
